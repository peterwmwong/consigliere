...
module.exports = (grunt)->
  ...
  grunt.initConfig
    ...
    browserify:
      ...
      app:
        src: "app/consigliere.coffee"
        dest: "build/app/consigliere.js"

      prod:
        src: "app/consigliere.coffee"
        dest: "build/app/consigliere.prod.js"
        options:
    ...
    cssmin:
      app:
        ...
        dest: "build/app/consigliere.min.css"

    ngmin:
      app:
        src: "<%= browserify.prod.dest %>"
        dest: "build/app/consigliere.ngmin.js"

    uglify:
      app:
        src: "<%= ngmin.app.dest %>"
        dest: "build/app/consigliere.min.js"
