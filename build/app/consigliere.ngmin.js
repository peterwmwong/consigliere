require = function e(t, n, r) {
  ...
  1: [
    function (require, module, exports) {
      ...
      angular.module('consigliere', [
        'ng',
        'ngResource'
      ]);
      require('./services/state.coffee');
      require('./elements/app.coffee');
    },
    {
      './elements/app.coffee': 2,
      './services/state.coffee': 4,
      'angular': 'ruNQ/y',
      'angular-resource': 'GqyS6t'
    }
  ],
  2: [
    function (require, module, exports) {
      require('../resources/SystemStatusResource.coffee');
      angular.module('consigliere').directive('app', function () {
        return {
          controller: [
            '$scope',
            'SystemStatusResource',
            '$timeout',
            function ($scope, SystemStatusResource, $timeout) {
              var constantlyUpdateStatus;
              constantlyUpdateStatus = function () {
                $scope.status = SystemStatusResource.get();
                return $timeout(constantlyUpdateStatus, 5000);
              };
              constantlyUpdateStatus();
              return $scope.$watch('status.issueStatus', function (newStatus, oldStatus) {
                if (newStatus != null && oldStatus != null) {
                  $scope.status.issueStatus = newStatus;
                  return $scope.status.$updateStatus();
                }
              });
            }
          ],
          restrict: 'E',
          template: '<h2>\n  Current Status: {{status.status}}\n</h2>\n<label>Issued Status<input class="issueStatus" ng-model="status.issueStatus" type="checkbox" /></label>\n'
        };
      });
      ;
    },
    { '../resources/SystemStatusResource.coffee': 3 }
  ],
  3: [
    function (require, module, exports) {
      angular.module('consigliere').factory('SystemStatusResource', [
        '$resource',
        function ($resource) {
          var DBURL, STATID, SystemStatusResource;
          ...
          return SystemStatusResource = $resource(DBURL, { id: STATID }, {
            updateStatus: {
              method: 'PUT',
              transformRequest: function (_arg) {
                var issueStatus, status;
                status = _arg.status, issueStatus = _arg.issueStatus;
  ...
  4: [
    function (require, module, exports) {
      angular.module('consigliere').factory('$state', function () {
        return {};
      });
    },
    {}
